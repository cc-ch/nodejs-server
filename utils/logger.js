...
// 加载配置文件  
var objConfig = JSON.parse(fs.readFileSync(process.env.ROOT+"/log4js.json", "utf8"));  
  
// 检查配置文件所需的目录是否存在，不存在时创建  
if(objConfig.appenders){  
    var baseDir = objConfig["customBaseDir"] || process.env.ROOT+"/../logs/";  
...
// console.log = logDebug.info;
// console.info = logDebug.info;
// console.warn = logDebug.warn;
// console.error = logDebug.error;
